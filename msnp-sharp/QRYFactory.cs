...
namespace MSNP11CHL 
{
	public class clsQRYFactory 
	{
		...
		public string CreateQRY(string strProductID, string strProductKey, string strCHLData) {
		...
		public ulong[] MD5_To_Int(string strMD5Hash) {
			// Create new array
		...
		public ulong[] CHLID_To_Int(string strCHLID) {
			// Create new arrays
		...
		public ulong Create_Key(ulong[] uMD5Ints, ulong[] uCHLIDInts) {
		...
		public string To_Hex(byte[] bBinary) {
		...
		public string Swap_Bytes(string strString, int iStep) {
