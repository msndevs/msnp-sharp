...
namespace MSNPSharpClient
{
    ...
    public class ConversationForm : System.Windows.Forms.Form
    {
        ...
        private void ConversationForm_Shown(object sender, EventArgs e)
        {
            ...
            {
                HttpDataDownloader.BeginDownload(remoteContact.UserTileURL.AbsoluteUri, new EventHandler<ObjectEventArgs>(SetUserTileToPictureBox), _messenger.ConnectivitySettings.WebProxy);
            }
        }
